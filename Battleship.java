...
public void aiTurn() {
	...
	if (agrid[x][y] == "x") {
		...
		System.out.print("Your destroyer done got sunked. Your turn, though!");
		usershipctr--;
		userdctr--;
	    }
	}
	    ...
	    agrid[x][y] = "x";
	    if (usersctr > 1) {
		System.out.print("Your sub took a hit from the ai! Your turn!");
		usersctr--;
	    }
	    else {
		System.out.print("Awww... Your sub done been sunked. On the bright side, it's your turn!");
		usershipctr--;
		usersctr--;
	    }
	}
	    ...
	    agrid[x][y] = "x";
	    if (userpctr > 1) {
		System.out.print("Your patrolboat has come recently come into fire. While I laugh at you, take your turn.");
		userpctr--;
	    }
	    else {
		System.out.println("Sick explosion, man. The ai sunk your patrolboat. Your turn now.");
		usershipctr--;
		userpctr--;
	    }
	}
